...
const en = {
  ...
  "hist.tab.summary": "Summary",
  "hist.tab.log": "Run log",
  "hist.tab.comments": "Comments",
  "hist.summary.empty": "The agent wrote no summary for this run.",
  "hist.summary.waiting": "No summary yet — the agent writes one as it works.",
...
const zhTW: Record<MessageKey, string> = {
  ...
  "hist.summary.empty": "代理人沒有為這次執行寫下摘要。",
  "hist.summary.waiting": "尚無摘要——代理人會在執行過程中寫下。",
  "hist.prompt": "送出的提示詞",
