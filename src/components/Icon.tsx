// Inline SVG icons in the Lucide visual style. Kept here so the bundle has
// no extra icon-font / sprite dependency. All glyphs are 24x24 stroke icons
// using `currentColor` so they tint with the surrounding text.
